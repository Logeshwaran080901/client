...
const NewLabour = () => {
    ...
    const handleSubmit = async () => {
        setLoader(true)
        await axios.post(`${baseUrl}/labour`, { labourname, businessid })
            .then((res) => {
                if (res) {
                    setLoader(false)
                    setLabourName('')
    ...
    return (
            ...
            <FieldSetLayout title=''>
                <div className="flex flex-col sm:flex-row sm:space-x-4">
                    ...
                    <div className="flex flex-col w-full sm:w-52">
                        <label htmlFor="name" className="mb-2 font-medium">Labour Name</label>
                        <input
                            type="text"
                            id="name"
                            value={labourname}
        ...
        //     <h2 className="text-2xl font-bold mb-4">Add New Labour</h2>
        ...
        //             />
        //         <div>
        //             <label htmlFor="name" className="block text-sm font-medium text-gray-700">Labour Name</label>
        //             <input
        //                 type="text"
        //                 id="name"
        //                 value={labourname}
